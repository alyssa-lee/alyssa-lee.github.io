...
- Research at CMU (school year or summer). See [this guide to getting involved in research]({% post_url 2023-12-08-research-advice %}). You can schedule an appointment with the Undergraduate Research Office to get advice. In addition, some students have joined labs at the University of Pittsburgh (a much bigger school with many more labs than CMU).
